...
## 🚨 Problem
Consumers lack an affordable smart cooling solution between basic air coolers (~₹5–6K) and expensive air conditioners (~₹30–45K), leaving a large underserved segment.
...
- Prioritized features using value vs implementation cost  
...
## 🧠 Product Thinking
Focused on balancing **affordability vs functionality** by prioritizing high-value, low-cost features.

Key trade-off:
- Avoided expensive features (voice assistant, air purification)  
- Focused on scalable features with minimal manufacturing changes  

---

## 📎 Case Study
[View Full Deck](./terracool-case-study.pdf)
